/**
 * Como con ts podemos obligar a tener interfaces, nosotros vamos a tener la interfaz
 * component, que va a tener si o si el método operation().
 * Entoces caada clase Concrete Component va a estar creada con esa interfaz.
 * 
 */
